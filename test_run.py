"""Manual integration smoke check — hits the live MLB API.

This is NOT a unit test (despite the filename). It makes real network calls,
so the work is guarded under __main__ to keep `pytest` collection offline-safe.
Run it directly:  python test_run.py
"""

from data_sources.mlb_client import find_game, find_games, load_game
from core.highlight_detector import top_moments
